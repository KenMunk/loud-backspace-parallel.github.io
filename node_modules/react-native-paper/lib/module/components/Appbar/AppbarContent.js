...
export default withInternalTheme(AppbarContent); // @component-docs ignore-next-line

const AppbarContentWithTheme = withInternalTheme(AppbarContent); // @component-docs ignore-next-line
