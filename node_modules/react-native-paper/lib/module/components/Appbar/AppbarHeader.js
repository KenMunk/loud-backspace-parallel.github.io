...
export default withInternalTheme(AppbarHeader); // @component-docs ignore-next-line

const AppbarHeaderWithTheme = withInternalTheme(AppbarHeader); // @component-docs ignore-next-line
