...
export default withInternalTheme(Checkbox); // @component-docs ignore-next-line

const CheckboxWithTheme = withInternalTheme(Checkbox); // @component-docs ignore-next-line
