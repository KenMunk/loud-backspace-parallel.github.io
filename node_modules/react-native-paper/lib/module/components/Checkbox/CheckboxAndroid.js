...
export default withInternalTheme(CheckboxAndroid); // @component-docs ignore-next-line

const CheckboxAndroidWithTheme = withInternalTheme(CheckboxAndroid); // @component-docs ignore-next-line
