...
export default withInternalTheme(CheckboxItem); // @component-docs ignore-next-line

const CheckboxItemWithTheme = withInternalTheme(CheckboxItem); // @component-docs ignore-next-line
