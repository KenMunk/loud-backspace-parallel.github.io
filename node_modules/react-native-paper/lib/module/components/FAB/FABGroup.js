...
export default withInternalTheme(FABGroup); // @component-docs ignore-next-line

const FABGroupWithTheme = withInternalTheme(FABGroup); // @component-docs ignore-next-line
