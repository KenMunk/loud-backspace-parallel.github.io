...
export default withInternalTheme(RadioButtonIOS); // @component-docs ignore-next-line

const RadioButtonIOSWithTheme = withInternalTheme(RadioButtonIOS); // @component-docs ignore-next-line
