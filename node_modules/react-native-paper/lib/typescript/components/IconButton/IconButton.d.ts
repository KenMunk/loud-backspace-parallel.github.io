...
import { GestureResponderEvent, StyleProp, TouchableWithoutFeedback, ViewStyle } from 'react-native';
 ...
 */
declare const IconButton: ({ icon, iconColor: customIconColor, containerColor: customContainerColor, size, accessibilityLabel, disabled, onPress, selected, animated, mode, style, ...rest }: Props) => JSX.Element;
