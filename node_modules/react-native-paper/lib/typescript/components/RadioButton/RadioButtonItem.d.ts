...
declare const _default: React.ComponentType<Pick<Props, "label" | "style" | "color" | "onPress" | "testID" | "accessibilityLabel" | "position" | "value" | "mode" | "disabled" | "labelStyle" | "status" | "uncheckedColor" | "labelVariant"> & {
...
declare const RadioButtonItemWithTheme: React.ComponentType<Pick<Props, "label" | "style" | "color" | "onPress" | "testID" | "accessibilityLabel" | "position" | "value" | "mode" | "disabled" | "labelStyle" | "status" | "uncheckedColor" | "labelVariant"> & {
    theme?: import("@callstack/react-theme-provider").$DeepPartial<unknown> | undefined;
}> & import("@callstack/react-theme-provider/typings/hoist-non-react-statics").NonReactStatics<React.ComponentType<Props> & {
    ({ value, label, style, labelStyle, onPress, disabled, color, uncheckedColor, status, theme, accessibilityLabel, testID, mode, position, labelVariant, }: Props): JSX.Element;
    displayName: string;
